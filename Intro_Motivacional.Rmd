...
setwd("C:/Talleres_Ecodiversa_R/Intro_Motivacional")
```
...
Desarrollaremos y comunicaremos de una manera clara la teoría y los conceptos que desde la ecología, evolución y otras disciplinas se han formulado para informar la práctica de la conservación. El manejo y análisis de datos será parte fundamental de los talleres.
...
Una serie de talleres que tengan como eje el análisis cuntitativo de datos, con base en la teoría y conceptos que se establece desde la ecología, la evolución y otras disciplinas, con el propósito de informar la práctica de la conservación de la biodiversidad.
...
+ Hacer preguntas y/o encontrar respuestas relacionadas con análisis de datos
...
+ y mucho mas……
+ ¿Tiene sugerencias?
+ (contáctenos: ecodiversatropical@gmail.com)
+
...
Somos un grupo de ecólogos latinoamericanos que compartimos un fuerte deseo y compromiso con la conservación de la biodiversidad neotropical.

Los invitamos a que sean parte de esta iniciativa!! (contáctenos: ecodiversatropical@gmail.com)
...
## ¿Con quien estaremos afiliados?

Estámos en la búsqueda de socios estratégicos con los que podamos ofrecer entrenamiento de calidad.  Por ahora tenermos acercamientos con el <a href="https://qcbs.ca/" target="_blank">Quebec Center for Biodiversity Science</a> de McGill University en Montreal (Canadá) y con la profesora-investigadora  <a href="https://www.lmguzman.com/" target="_blank">Melissa Guzmán</a> de University of Southern California (US). 
...
Ecodiversa Tropical es una organización sin ánimo de lucro (ONG) dedicada a la conservación de la conservación. Dentro del programa de liderazgo queremos ofrecer oportunidades para el desarrollo investigativo y profesional encaminados a la conservación de la biodiversidad.
...
<a href="https://www.ecodiversatropical.com/" target="_blank">![](./Figures/ecodiversa.png){width=1000% height="160"}</a>
...
Las bases de datos de GBIF han servido de insumo para identificar patrones de biodiversidad, evaluar hipótesis, identificar vacíos de información e informar políticas y estrategias globales de protección de la biodiversidad.
...
<a href="https://biodiversidad.co/" target="_blank">![](./Figures/gbif.png){width=50% height="100%" align="right"}</a>
Observaciones de especies (en millones)
...
<a href="https://earthexplorer.usgs.gov/" target="_blank">![](./Figures/USGS Earth Explorer.png){width=50% height="100%"}</a>
...
No nos olvidemos la importancia de los aspectos ambientales, como las condiciones físicas y climáticas de una región o paisaje, que intervienen en la dinámica de las especies y los ecosistemas. Más ahora que se han constituido en un motor de cambio debido a las actividades humanas que han interrumpido y afectado estas dinámicas a niveles globales y locales.
...
+ Planes de ordenamiento territorial (<a href="https://www.minvivienda.gov.co/espacio-urbano-y-territorial/plan-de-ordenamiento-territorial" target="_blank">ver más información aquí</a>).
...
Hay otras opciones en el mercado (ver ejemplos en la figura de abajo) y debemos tomar ventaja de todo sus potenciales, en especial aquellas que son abiertas al uso público sin costo alguno (open-source).
...
Por ejemplo, una disminución dramática en la tasa de deforestación entre 2004 y 2012 (ver figura) ha sido asociada a varios factores  (<a href="https://www.nature.com/articles/s41559-020-01368-x" target="_blank">Junior et al., 2021</a> and 
<a href="https://www.science.org/doi/10.1126/science.1248525" target="_blank">Nepstad et al., 2014</a>):
...
Varios países han empezado sus evaluaciones. Por ejemplo, <a href="https://sandbox.makinaeditorial.com/ecosistemas-colombianos/build/#/" target="_blank">Etter et al (2020)</a> han desarrollado el mapa de amenazas y riesgos para los ecosistemas Colombianos. 
...
La figura muestra el porcentaje esperado de pérdida en la agricultura debido a la ausencia de polinización animal.


![](./Figures/ipbes.png){width=100% height="200%"}
<br>
...
R y R Studio hacen parte de este concepto global de democratizar y hacer accesible el uso de heeramientas para cualquier potencial usuario. 
...
<br>
Hasta un poco más interactivas en donde usted puede mover el cursor sobre los datos para visualizar datos específicos.
...
<br>
También podemos visualizar información espacial como mapas. Por ejemplo estos datos que se encuentran en uno de los paquetes.
...
Empezaremos a dictar virtualmente los Talleres Introductorios en R a mediados de junio del 2022. 

Por favor este pendiente y difundir esta información.


Si tiene comentarios y/o sugerencias contáctenos: ecodiversatropical@gmail.com
